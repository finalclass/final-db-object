...
import IDataStoreAdapter = require('./interfaces/IDataStoreAdapter');
import IDataStoreSQLiteConfig = require('./interfaces/IDataStoreSQLiteConfig');
import IVariable = require('./interfaces/IVariable');
import IRawData = require('./interfaces/IRawData');
import IVariablesCollection = require('./interfaces/IVariablesCollection');
